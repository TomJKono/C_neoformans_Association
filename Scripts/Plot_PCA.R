...
# labeled plot of the first two PCs (for talks etc).
...
# pdf(file="Cn_38_Strains.ST93A.PCA.pdf", height=12, width=12)
pdf(file="Cn_38_Strains.PCA.pdf", height=12, width=12)
pairs(
    eigvec[, -c(1, 2)],
    upper.panel=NULL,
    pch=19,
...
# pdf(file="Cn_38_Strains.ST93A.Scree.pdf", height=6, width=6)
pdf(file="Cn_38_Strains.Scree.pdf", height=6, width=6)
...
# pdf(file="Cn_38_Strains.ST93A.PC1-vs-PC2.pdf", height=6, width=6)
pdf(file="Cn_38_Strains.PC1-vs-PC2.pdf", height=6, width=6)
